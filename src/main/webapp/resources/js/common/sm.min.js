...
$.smVersion = "0.6.2", +function (a) {
    ...
    var b = !1, c = function (c) {
        ...
        return h.animating = !1, h.addValue = function (a) {
            ...
            var b = a(this).attr("data-month"), c = h.wrapper.find(".picker-calendar-month-current").attr("data-year"),
            ...
            var c = parseInt(h.months.eq(0).attr("data-month"), 10), d = parseInt(h.months.eq(0).attr("data-year"), 10),
                e = new Date(d, c + 1, -1), f = e.getTime(), g = !h.animating;
            ...
            var a, b = "", c = "", d = h.value && h.value.length ? h.value[0] : (new Date).setHours(0, 0, 0, 0),
                e = h.yearsGroupHTML(d, "prev"), f = h.yearsGroupHTML(d), g = h.yearsGroupHTML(d, "next"),
                ...
                k = h.monthHTML(d, "prev"), l = h.monthHTML(d), m = h.monthHTML(d, "next"),
